...
{
    /// <summary>
    /// Runtime options for <see cref="Interceptors.DragonfireServerLoggingInterceptor"/>.
    /// Configure once at DI registration time; the same instance is injected into every call.
    /// </summary>
    public sealed class DragonfireGrpcServerOptions
    {
        /// <summary>
        /// Extract and log scalar fields from the incoming proto request message as
        ...
        /// bidirectional calls receive a stream of requests, not a single message.
        /// Default: <c>true</c>.
        /// </summary>
        public bool LogRequestFields { get; set; } = true;

        /// <summary>
        /// Extract and log scalar fields from the outgoing proto response message as
        ...
        /// bidirectional calls produce a stream of responses, not a single message.
        /// Default: <c>true</c>.
        /// </summary>
        ...
        /// Example: add <c>"password"</c> to suppress <c>Request.password</c>.
        /// </summary>
